    ...
    return (
        <div className='our-services-section flex flex-col items-center h-fit w-screen box-border py-[56px] pb-[100px]'>
            ...
            <div className="individuals services-section w-[82%] sm-max:w-[95%]">
                ...
                <div className="category-card-wrapper flex justify-evenly sm-max:flex-wrap sm-max:gap-[30px]">
                    <div className="category-card w-[360px] h-fit sm-max:w-full">
                        <img className='h-[160px] w-[360px] mb-[25px] sm-max:mb-[2px] sm-max:w-full sm-max:h-auto' src="https://www.carzonrent.com/webcor/images/banner/city-to-city-ride.png" alt="" />
                        <div className="category-card-info">
