...
import {helpline,flexiblepaymentoption,nosurgepricing_yellow,transparentbilling,automatedbookingtools,
  longtermsrental,plugevcabs,corporateevents,campusfleet,corporatebanner
  ,airporttransfer,ets,dailycommute,
  delegatetransfer,psubanner} from '../src/assets';
...
let GovPSUTravel=()=>{
  ...
  return (
    <div>
    <div className="w-full min-h-screen" style={{ backgroundImage: `url(${psubanner})`, backgroundSize: 'cover',backgroundPosition: 'center',
      ...
      <main className="flex flex-col items-start justify-center text-white text-left py-10 px-5 sm:py-20 sm:px-10">
        <div className="max-w-4xl mt-10 sm:mt-24 sm:ml-20" data-aos="fade-down" data-aos-delay="400">
          <h1 className="text-3xl sm:text-5xl font-bold mb-4">Reliable PSU Travel Solutions</h1>
          <p className="text-lg sm:text-xl mb-6 sm:mb-12 mt-2 sm:mt-4 font-bold"></p>
        </div>
      </main>
      ...
      <div className=" px-5 sm:px-10 py-10 sm:py-16 bg-slate-100">
        <div className="mx-auto max-w-2xl sm:max-w-7xl">
          <h2 className="text-2xl sm:text-4xl text-center font-bold tracking-tight text-gray-700 mb-4">Tailored Solutions For PSU Travels</h2>
          <h3 className="text-lg sm:text-xl text-center tracking-tight text-gray-950 mb-10">Discover Our Premium Chauffeur Cab Service</h3>
          ...
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:gap-x-16 sm:gap-y-28 sm:grid-cols-3 lg:grid-cols-3 xl:gap-x-14">
            ...
            <div className="group relative" data-aos="zoom-in">
              ...
              <div className="mt-4 flex flex-col justify-between">
                <h3 className="text-xl sm:text-2xl text-center text-black font-semibold">
                    <span aria-hidden="true" className="absolute inset-0"></span>
                    Elevate Government Events
                </h3>
                <p className="mt-1 text-sm sm:text-base text-gray-500 text-center">Elevate Govt and PSU events with our premium cab services for unmatched professionalism. <a href="#" className='text-yellow-400'> Learn More</a></p>
              </div>
            </div>
