...
import {helpline,flexiblepaymentoption,nosurgepricing_yellow,transparentbilling,
    longtermsrental,plugevcabs,outstrationtravels
    ,airporttransfer,dailycommute,
    smetravels,cor_app_yellow} from '../src/assets';
    ...
    return (
        <div>
            <div className="w-full min-h-screen "
                style={{
                    backgroundImage: `url(${smetravels})`,
                ...
                <main className="flex flex-col items-start justify-center text-white text-left py-10 px-5 sm:py-20 sm:px-10">
                    <div className="max-w-4xl mt-10 sm:mt-24 sm:ml-20" data-aos="fade-down" data-aos-delay="400">
                        <h1 className="text-3xl sm:text-5xl font-bold mb-4">Exclusive Transportation <br /> Solutions Tailored For SMEs</h1>
            ...
            <div className="px-5 sm:px-10 py-10 sm:py-16 bg-slate-100">
                <div className="mx-auto max-w-2xl sm:max-w-7xl">
                    <h2 className="text-2xl sm:text-4xl text-center font-bold tracking-tight text-gray-700 mb-4">Optimize Your SME Travel Experience</h2>
                    <h3 className="text-lg sm:text-xl text-center tracking-tight text-gray-950 mb-10">Dive into Premium Cab Rental</h3>
                    ...
                    {/* 2nd Row */}
                    <div className="mt-6 grid grid-cols-1 items-center justify-center gap-x-6 gap-y-10 sm:gap-x-16 sm:gap-y-28 sm:grid-cols-3 lg:grid-cols-3 xl:gap-x-14">
                        {/* Image1 */}
                        <div className="group relative" data-aos="zoom-in">
                            <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80">
                                <img src={longtermsrental} alt="Long Term Rentals" className="h-full w-full object-cover object-center lg:h-full lg:w-full" />
                            </div>
                            <div className="mt-4 flex flex-col justify-between">
                                <h3 className="text-xl sm:text-2xl text-center text-black font-semibold">
                                        <span aria-hidden="true" className="absolute inset-0"></span>
                        ...
                        <div className="group relative" data-aos="zoom-in">
                            <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80">
                                <img src={outstrationtravels} alt="Outstation Travel" className="h-full w-full object-cover object-center lg:h-full lg:w-full" />
                            </div>
                            <div className="mt-4 flex flex-col justify-between">
                                <h3 className="text-xl sm:text-2xl text-center text-black font-semibold">
                                        <span aria-hidden="true" className="absolute inset-0"></span>
            ...
            <div className="bg-white px-5 sm:px-10 py-10 sm:py-16">
                <div className="mx-auto max-w-2xl sm:max-w-7xl">
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-3 lg:grid-cols-3">
                        ...
                        <div className="flex flex-col items-center justify-between p-6 rounded-lg bg-white" data-aos="zoom-in">
                            <img
                                ...
                                className="h-24 w-24 object-contain mb-4"
                            />
                            <h3 className="text-xl sm:text-2xl text-center text-black font-semibold mb-2">COR App</h3>
                            <p className="text-sm sm:text-base text-gray-500 text-center">
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-3 lg:grid-cols-2">
