...
import {
    helpline, flexiblepaymentoption,nosurgepricing_yellow, transparentbilling, automatedbookingtools,smetravels
} from '../src/assets';
    ...
    return (
        <div>
            <div className="w-full min-h-screen" style={{
                backgroundImage: `url(${smetravels})`, backgroundSize: 'cover', backgroundPosition: 'center',
                backgroundRepeat: 'no-repeat'
            }}>

                <main className="flex flex-col items-start justify-center font-serif font-bold italic text-lg text-black text-left py-10 px-5 sm:py-20 sm:px-10">
                    <div className="max-w-4xl mt-10 sm:mt-24 sm:ml-20" data-aos="fade-down" data-aos-delay="400">
                        ...
                        <p className="text-lg sm:text-xl mb-6 sm:mb-12 mt-2 sm:mt-4 font-bold">Travel in utmost luxury and sophistication with our 
                            premier chauffeur services. <br /> Whether for business or leisure, enjoy a smooth and punctual airport transfer, <br /> with every
                             detail catered to your comfort and convenience.</p>
                    </div>
                </main>
            ...
            <div className="px-5 sm:px-10 py-10 sm:py-16 bg-gray-100">
                <div className="mx-auto max-w-2xl sm:max-w-7xl">
                    <h2 className="text-2xl sm:text-4xl text-center font-bold tracking-tight text-gray-700 mb-4">Why Choose TRIP-C for SME Travel?</h2>
                    <div className="mt-6 space-y-6 text-lg text-gray-700">
                        <div data-aos="fade-up" data-aos-delay="100">
                            <h3 className="text-xl font-semibold">Affordable Fleet Options</h3>
                            <p>Our range of vehicles is designed to meet the needs of SMEs, offering cost-effective options without compromising on quality and comfort.</p>
                        </div>
                        <div data-aos="fade-up" data-aos-delay="200">
                            <h3 className="text-xl font-semibold">Experienced Drivers</h3>
                            <p>Benefit from our professional drivers who ensure safe and reliable transportation, allowing you to focus on your business.</p>
                        </div>
                        <div data-aos="fade-up" data-aos-delay="300">
                            <h3 className="text-xl font-semibold">Simple Booking Process</h3>
                            <p>Our user-friendly booking system makes it easy for SMEs to arrange travel, with options available 24/7 to suit your schedule.</p>
                        </div>
                        <div data-aos="fade-up" data-aos-delay="400">
                            <h3 className="text-xl font-semibold">Flexible Travel Plans</h3>
                            <p>Customize your travel plans to fit your business needs, including multi-stop trips and on-demand bookings.</p>
                        </div>
                        <div data-aos="fade-up" data-aos-delay="500">
                            <h3 className="text-xl font-semibold">Real-Time Updates</h3>
                            <p>Stay informed with real-time updates on your travel arrangements, ensuring you are always on schedule.</p>
                        </div>
                    </div>
                </div>
            </div>
