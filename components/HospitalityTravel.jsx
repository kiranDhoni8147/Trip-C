...
let HospitalityTravel=()=>{
  ...
  return (
    <div>
    <div className="w-full min-h-screen" style={{ backgroundImage: `url(${hospitalbanner})`, backgroundSize: 'cover',backgroundPosition: 'center',
      ...
      <main className="flex flex-col items-start justify-center text-white text-left py-10 px-5 sm:py-20 sm:px-10">
        <div className="max-w-4xl mt-10 sm:mt-24 sm:ml-20" data-aos="fade-down" data-aos-delay="400">
          <h1 className="text-3xl sm:text-5xl font-bold mb-4">Elite Chauffeured Cab <br /> Services For Hotel Travel</h1>
      ...
      <div className=" px-5 sm:px-10 py-10 sm:py-16 bg-slate-100">
        <div className="mx-auto max-w-2xl sm:max-w-7xl">
          <h2 className="text-2xl sm:text-4xl text-center font-bold tracking-tight text-gray-700 mb-4">Ultimate Comfort For Hotel Transfers</h2>
          <h3 className="text-lg sm:text-xl text-center tracking-tight text-gray-950 mb-10">Embark on the Luxury Cab Rental Experience</h3>
          ...
          <div className="mt-6 h grid grid-cols-1 gap-x-6 gap-y-10 sm:gap-x-16 sm:gap-y-28 sm:grid-cols-3 lg:grid-cols-3 xl:gap-x-14">
            ...
            <div className="group relative" data-aos="zoom-in">
              <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80">
                <img src={staffcars} alt="Daily Commute" className="h-full w-full object-cover object-center lg:h-full lg:w-full" />
              </div>
              <div className="mt-4 flex flex-col justify-between">
                ...
                <p className="mt-1 text-sm sm:text-base text-gray-500 text-center">Efficient and reliable staff transfer solutions ensuring hassle-free hotel travel experiences.<a href="#" className='text-yellow-400'> Learn More</a></p>
              </div>
            </div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:gap-x-16 sm:gap-y-28 sm:grid-cols-3 lg:grid-cols-3 xl:gap-x-14">
            ...
            <div className="group relative" data-aos="zoom-in">
              ...
              <div className="mt-4 flex flex-col justify-between">
                ...
                <p className="mt-1 text-sm sm:text-base text-gray-500 text-center">Elevate your events with our premium cab services for unmatched professionalism.<a href="#" className='text-yellow-400'> Learn More</a></p>
              </div>
            </div>
            ...
            <div className="group relative" data-aos="zoom-in">
              <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80">
                <img src={campusfleet} alt="Airport Transfers" className="h-full w-full object-cover object-center lg:h-full lg:w-full" />
              </div>
              <div className="mt-4 flex flex-col justify-between">
                <h3 className="text-xl sm:text-2xl text-center text-black font-semibold">
                    <span aria-hidden="true" className="absolute inset-0"></span>
                ...
                <p className="mt-1 text-sm sm:text-base text-gray-500 text-center">Elevate your guests' experience with dedicated hotel car services from Carzonrent. <a href="#" className='text-yellow-400'> Learn More</a></p>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-2xl sm:max-w-7xl">
          ...
          <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-3 lg:grid-cols-3">
            ...
            <div className="flex flex-col items-center justify-between p-6 rounded-lg bg-white" data-aos="zoom-in">
              ...
              />
              <h3 className="text-xl sm:text-2xl text-center text-black font-semibold mb-2">Meet & Greet</h3>
              <p className="text-sm sm:text-base text-gray-500 text-center">
              Experience convenience from the moment you land with Carzonrent's Meet and Greet services at airports to make your journey smooth and hassle-free
              </p>
            </div>
            ...
            <div className="flex flex-col items-center justify-between p-6 rounded-lg bg-white" data-aos="zoom-in">
              <img
                src={experiencechauffer}
                alt="Automated Booking Tools"
                className="h-24 w-24 object-contain mb-4"
              />
              <h3 className="text-xl sm:text-2xl text-center text-black font-semibold mb-2">Experienced Chauffeurs</h3>
              <p className="text-sm sm:text-base text-gray-500 text-center">
              Carzonrent employs police-verified, skilled chauffeurs for a secure and professional travel experience, prioritizing passenger safety and satisfaction.
              </p>
            </div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-2">
            ...
            <div className="flex flex-col items-center justify-between p-6 rounded-lg bg-white" data-aos="zoom-in">
              <img
                ...
                className="h-24 w-24 object-contain mb-4"
              />
              <h3 className="text-xl sm:text-2xl text-center text-black font-semibold mb-2">Luxury Fleet</h3>
              <p className="text-sm sm:text-base text-gray-500 text-center">
              Carzonrent's impressive luxury fleet provides a distinguished range of upscale vehicles, ensuring a refined and comfortable travel experience.
              </p>
            </div>
