...
const Faq = () => {
    ...
    return (
        <div className="container mx-auto sm:px-4 sm:py-6 px-4 py-8">
            <div className="bg-white rounded-lg shadow-lg sm:p-6 p-4">
                <div className="flex flex-col md:flex-row justify-between px-4 items-center mb-6">
                    ...
                    {faqData.map((faq, index) => (
                        <div key={index} className="mb-4">
                            <button
                                ...
                                className="w-full font-bold sm:text-sm text-lg text-left py-2 px-4 rounded-lg focus:outline-none transition-colors duration-200 ease-in-out hover:bg-gray-200"
                            >
                                {faq.question}
                            </button>
